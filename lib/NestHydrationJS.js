...
(function (NestHydrationJS_1) {
    ...
    var NestHydrationJS = /** @class */ (function () {
        ...
        NestHydrationJS.prototype.nest = function (data, structPropToColumnMap, verbose) {
            ...
            var meta = this.buildMeta(structPropToColumnMap, verbose);
            // BUILD FROM TABLE
         ...
         */
        NestHydrationJS.prototype.buildMeta = function (structPropToColumnMap, verbose) {
            if (verbose === void 0) { verbose = false; }
            var meta;
            ...
            if (isArray(structPropToColumnMap)) {
                ...
                var keys_1 = columns.reduce(function (accumulator, column) {
                    if (column.id === true) {
                ...
                if (keys_1.length === 0) {
                    if (typeof columns[0] === 'string') {
                        keys_1.push(columns[0]);
                    }
                    else if (typeof columns[0].column === 'string') {
                        keys_1.push(columns[0].column);
                    }
                }
                meta.primeIdColumnList.push(keys_1);
                // construct the rest
